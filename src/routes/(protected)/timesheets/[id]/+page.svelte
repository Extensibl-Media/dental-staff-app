<script lang="ts">
  ...
  const weekBeginDate = parse(data.timesheet!.weekBeginDate, 'yyyy-MM-dd', new Date());
  ...
  function getCostEstimate() {
    const hourlyRate = parseInt(data?.timesheet?.candidateRateBase as string) || 0;
            ...
            <CardHeader>
              <div class="flex flex-wrap items-start justify-between gap-2">
                <div>
                  ...
                  <CardDescription>
                    <p>• Candidate: {data?.timesheet?.candidate?.firstName} {data?.timesheet?.candidate?.lastName}</p>
            ...
            <CardContent class="space-y-6">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                ...
                <div class="p-3 bg-gray-50 rounded-lg">
                  ...
                  <p class="text-xl font-bold">${(data?.timesheet?.candidateRateBase * parseFloat(data?.timesheet?.totalHoursWorked || '0')).toFixed(2)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <TabsList class="grid grid-cols-3 w-full">
              ...
              <TabsTrigger value="history">
                ...
                {#if correctionHistory && correctionHistory.length}
                  <span class="absolute top-0.5 right-2 flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 text-xs font-semibold text-blue-800">
              ...
              <Card>
                <CardHeader>
                  <div class="flex items-center justify-between">
                    ...
                    <Button variant="outline" class="gap-1 text-green-700 border-green-200 hover:bg-green-50">
                      <Edit class="h-4 w-4" />
                      Bulk Edit Hours
                    </Button>
                  </div>
                ...
                <CardContent>
                  ...
                  {:else}
                    <div class="p-8 text-center">
                      ...
                      <p class="text-gray-600 mt-1">No corrections or overrides have been made to this timesheet.</p>
                    </div>
                  {/if}
                </CardContent>
              </Card>
            ...
            <CardContent class="space-y-4">
              ...
              {#if hasDiscrepancies()}
                <Alert variant="destructive" class="mt-3">
                  ...
                  <AlertDescription>
                    This timesheet has unresolved discrepancies. Correct them or use the override function.
                  </AlertDescription>
                </Alert>
              {/if}
            </CardContent>
