        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            <DropdownMenuSeparator />
              <DropdownMenuItem on:click={() => window.location.href = '/timesheets/' + workday?.workday.id}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <DropdownMenuItem on:click={() => window.location.href = '/invoices?workdayId=' + workday?.workday.id}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
